...
// 	"github.com/StorXNetwork/StorXMonitor/cmd/uplink/cmd"
...
// 	"storxnetwork.io/edge/pkg/auth"
// 	"storxnetwork.io/edge/pkg/auth/badgerauth"
// 	"storxnetwork.io/edge/pkg/authclient"
// 	"storxnetwork.io/edge/pkg/server"
// 	"storxnetwork.io/edge/pkg/trustedip"
// )
...
// 			},
// 		}
// 		authService, err := auth.New(ctx, zaptest.NewLogger(t).Named("auth"), authConfig, fpath.ApplicationDir("storxnetwork", "authservice"))
// 		require.NoError(t, err)
