...
func RestrictGrant(accessGrant string, paths []string, permission Permission) (string, error) {
	...
	restricted, err := access.Restrict(
		grant.Permission{
			...
			AllowPutBucketNotificationConfiguration: permission.AllowPutBucketNotificationConfiguration,
			AllowGetBucketNotificationConfiguration: permission.AllowGetBucketNotificationConfiguration,
