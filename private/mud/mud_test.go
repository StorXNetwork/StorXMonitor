...
func TestSortedDependency(t *testing.T) {
	...
	require.Equal(t, "github.com/StorXNetwork/StorXMonitor/private/mud.DB", sorted[0].ID())
	require.Equal(t, "github.com/StorXNetwork/StorXMonitor/private/mud.Service1", sorted[1].ID())
	require.Equal(t, "github.com/StorXNetwork/StorXMonitor/private/mud.Service2", sorted[2].ID())
}
