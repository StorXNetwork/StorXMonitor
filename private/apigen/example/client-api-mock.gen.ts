...
export class UsersHttpApiV0 {
    ...
    public async get(): Promise<User[]> {
        ...
        return JSON.parse('[{"name":"Storj","surname":"Labs","email":"storxnetwork@storxnetwork.test","company":"Test 1","position":"Tester"},{"name":"Test1","surname":"Testing","email":"test1@example.test","company":"Test 2","position":"Accountant"},{"name":"Test2","surname":"Testing","email":"test2@example.test","company":"Test 3","position":"Slacker"}]') as User[];
    }
