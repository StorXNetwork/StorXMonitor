...
// Source: github.com/StorXNetwork/StorXMonitor/satellite/orders (interfaces: Overlay)
//
...
import (
	...
	nodeselection "github.com/StorXNetwork/StorXMonitor/satellite/nodeselection"
...
func (m *MockOverlayForOrders) Get(ctx context.Context, nodeID storxnetwork.NodeID) (*overlay.NodeDossier, error) {
	m.ctrl.T.Helper()
...
func (m *MockOverlayForOrders) GetOnlineNodesForAudit(arg0 context.Context, arg1 []storxnetwork.NodeID) (map[storxnetwork.NodeID]*overlay.NodeReputation, error) {
	m.ctrl.T.Helper()
