...
type Config struct {
	...
	StorjGCPCarbon                 float64 `help:"amount of carbon emission from storxnetwork GCP, in kg" default:"3600"`
	StorjCRDBCarbon                float64 `help:"amount of carbon emission from storxnetwork CRDB, in kg" default:"2650"`
	StorjEdgeCarbon                float64 `help:"amount of carbon emission from storxnetwork Edge, in kg" default:"10924"`
	...
	StorjExpansionFactor           float64 `help:"expansion factor of storxnetwork network" default:"2.7"`
	...
	StorjRegionCount               float64 `help:"region count of storxnetwork network" default:"1"`
	...
	StorjUtilizationFraction       float64 `help:"utilization fraction of storxnetwork network, in fraction" default:"0.85"`
