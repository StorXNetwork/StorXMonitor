...
-- NEW DATA --
INSERT INTO payment_customers (user_id, provider, provider_customer_id, created_at) VALUES (b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x11', 'razorpay', 'cust_test', CURRENT_TIMESTAMP());
INSERT INTO payment_methods (id, user_id, provider, provider_method_id, brand, last4, exp_month, exp_year, is_default, created_at) VALUES (b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x12', b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x11', 'razorpay', 'token_test', 'visa', '1111', 12, 2030, true, CURRENT_TIMESTAMP());
INSERT INTO payment_attempts (id, user_id, plan_id, provider, provider_ref, amount_minor, currency, status, coupon_code, metadata, created_at, updated_at) VALUES (b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x13', b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x11', 1, 'razorpay', 'order_test', 10000, 'INR', 'pending', NULL, NULL, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO payment_subscriptions (id, user_id, plan_id, provider, provider_sub_id, provider_plan_id, status, current_period_end, cancel_at_period_end, default_method_id, coupon_code, created_at, updated_at) VALUES (b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x14', b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x11', 1, 'razorpay', 'sub_test', 'plan_test', 'active', NULL, false, b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x12', NULL, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO payment_events (id, provider, provider_event_id, event_type, payload, attempt_id, subscription_id, received_at) VALUES (b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x15', 'razorpay', 'evt_test', 'payment.captured', JSON '{}', b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x13', NULL, CURRENT_TIMESTAMP());
