...
// 				memberKey, _, err := service.CreateAPIKey(memberCtx, up1Proj.ID, "member-key")
// 				require.NoError(t, err)
// 				require.Equal(t, member.ID, memberKey.CreatedBy)

// 				// Owner creates an API key (should not be affected).
// 				ownerKey, _, err := service.CreateAPIKey(ownerCtx, up1Proj.ID, "owner-key-for-remove-test")
// 				require.NoError(t, err)
...
// 				_, _, err = service.CreateAPIKey(userCtx1, disabledProject.ID, "test key")
// 				require.True(t, console.ErrUnauthorized.Has(err))

// 				createdAPIKey, _, err = service.CreateAPIKey(userCtx2, up2Proj.ID, "test key 1")
// 				require.NoError(t, err)
// 				require.NotNil(t, createdAPIKey)
...
// 				createdAPIKey, _, err = service.CreateAPIKey(userCtx2, up2Proj.ID, "test key 2")
// 				require.NoError(t, err)
// 				require.NotNil(t, createdAPIKey)
...
// 				createdAPIKey, _, err = service.CreateAPIKey(userCtx2, up2Proj.ID, "test key 3")
// 				require.NoError(t, err)
// 				require.NotNil(t, createdAPIKey)
