...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/consoleapi.SetAuthOnboardingStatusSwaggerRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/fcm-token": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "FCM token and device metadata",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/consoleapi.RegisterTokenRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/consoleapi.UpdateTokenRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/notification-preferences": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter: billing, backup, account, vault",
                        "name": "category",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "consoleapi.RegisterTokenRequest": {
            "type": "object",
            "properties": {
                "appVersion": {
                ...
                "browserName": {
                    "description": "Optional: browser name (web only)",
                    "type": "string"
                },
                "deviceId": {
                ...
                "deviceType": {
                    "description": "Optional: \"android\", \"ios\", \"web\"",
                    "type": "string"
                },
                "osVersion": {
                ...
                "token": {
                    "description": "Required: FCM token",
                    "type": "string"
                },
                "userAgent": {
                    "description": "Optional: full user agent string",
                    "type": "string"
                }
            }
        },
        ...
        "consoleapi.SetAuthOnboardingStatusSwaggerRequest": {
            "type": "object",
            "properties": {
                "onboardingEnd": {
                    "type": "boolean",
    ...
    "tags": [
        ...
        {
            "description": "Account \u0026 session: profile, settings, refresh-session, developer-access, MFA, FCM tokens, notification-preferences",
            "name": "auth-account"
        },
        {
