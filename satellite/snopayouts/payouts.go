...
type DB interface {
	...
	GetPaystub(ctx context.Context, nodeID storxnetwork.NodeID, period string) (Paystub, error)
	// GetAllPaystubs return all payStubs by nodeID.
	GetAllPaystubs(ctx context.Context, nodeID storxnetwork.NodeID) ([]Paystub, error)

	// GetPayment return storagenode payment by nodeID and period.
	GetPayment(ctx context.Context, nodeID storxnetwork.NodeID, period string) (Payment, error)
	// GetAllPayments return all payments by nodeID.
	GetAllPayments(ctx context.Context, nodeID storxnetwork.NodeID) ([]Payment, error)
...
func (service *Service) GetPaystub(ctx context.Context, nodeID storxnetwork.NodeID, period string) (Paystub, error) {
...
func (service *Service) GetAllPaystubs(ctx context.Context, nodeID storxnetwork.NodeID) ([]Paystub, error) {
...
func (service *Service) GetPayment(ctx context.Context, nodeID storxnetwork.NodeID, period string) (Payment, error) {
...
func (service *Service) GetAllPayments(ctx context.Context, nodeID storxnetwork.NodeID) ([]Payment, error) {
