...
func (reporter *DBReporter) recordAuditStatus(ctx context.Context, nodeIDs storxnetwork.NodeIDList, nodesReputation map[storxnetwork.NodeID]overlay.ReputationStatus, auditOutcome reputation.AuditType) (failed storxnetwork.NodeIDList, err error) {
