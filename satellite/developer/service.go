...
func NewService(
	...
	return NewServiceWithMail(log, store, analytics, tokens, config, regTokenChecker, nil, "")
}

// NewServiceWithMail returns a new instance of Service with mail service support.
func NewServiceWithMail(
	log *zap.Logger,
	store console.DB,
	analytics *analytics.Service,
	tokens *consoleauth.Service,
