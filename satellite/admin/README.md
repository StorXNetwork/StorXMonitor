...
satellite-admin:
  ...
  environment:
    ####
    ####
    STORJ_ADMIN_USER_GROUPS_ROLE_ADMIN: "admins@test.test" # comma separated for multiple groups
    # optional if you want to test view only access. check the code for other roles.
    STORJ_ADMIN_USER_GROUPS_ROLE_VIEWER: "viewers@test.test" # comma separated for multiple groups
