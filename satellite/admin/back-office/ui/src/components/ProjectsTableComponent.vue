        ...
        >
            ...
            <template #item.email="{ item }">
                <v-chip
                    ...
                    size="small"
                    rounded="lg"
                    @click="setSearch(item.raw.email)"
                >
                    {{ item.raw.email }}
                </v-chip>
            </template>
            ...
            <template #item.agent="{ item }">
                <v-chip
                    ...
                    size="small"
                    rounded="lg"
                    @click="setSearch(item.raw.agent)"
                >
                    {{ item.raw.agent }}
                </v-chip>
            </template>
            ...
            <template #item.storagepercent="{ item }">
                <v-chip
                    variant="tonal"
                    :color="getPercentColor(item.raw.storagepercent)"
                    size="small"
                    rounded="lg"
            ...
            <template #item.downloadpercent="{ item }">
                <v-chip
                    variant="tonal"
                    :color="getPercentColor(item.raw.downloadpercent)"
                    size="small"
                    rounded="lg"
                    class="font-weight-bold"
                >
                ...
                <v-tooltip text="430,000 / 1,000,000">
                    <template #activator="{ props }">
                        <v-chip
                            v-bind="props"
                            variant="tonal"
                            :color="getPercentColor(item.raw.segmentpercent)"
                            size="small"
                            rounded="lg"
                            class="font-weight-bold"
                        >
