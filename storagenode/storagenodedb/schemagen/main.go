...
func runSchemaGen(ctx context.Context, log *zap.Logger) (_ []byte, err error) {
	...
	printf(`//lint:file-ignore * generated file
		// AUTOGENERATED BY github.com/StorXNetwork/StorXMonitor/storagenode/storagenodedb/schemagen.go
		// DO NOT EDIT

		package storagenodedb

		import "github.com/StorXNetwork/StorXMonitor/shared/dbutil/dbschema"
