...
func NewBlobsUsageCacheTest(log *zap.Logger, blob blobstore.Blobs, piecesTotal, piecesContentSize, trashTotal int64, spaceUsedBySatellite map[storxnetwork.NodeID]SatelliteUsage) *BlobsUsageCache {
